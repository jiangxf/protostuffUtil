package org.achievement.StaticUtil;

import com.dyuproject.protostuff.LinkedBuffer;
import com.dyuproject.protostuff.ProtostuffIOUtil;
import com.dyuproject.protostuff.Schema;
import com.dyuproject.protostuff.runtime.RuntimeSchema;
import org.achievement.entity.SerializeDeserializeWrapper;
...
public class ProtostuffUtils {
     ...
     * 缓存对象及对象schema信息集合
     */
    private static final Map<Class<?>, Schema<?>> CACHE_SCHEMA = new HashMap<Class<?>, Schema<?>>();
    ...
    public static <T> byte[] serialize(T obj) {
        ...
        try {
            ...
            logger.error("serialize exception [" + obj + "]", e);
